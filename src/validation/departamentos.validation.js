...
export const validateCrearDepartamento = [
	check(
		"nombre_departamento",
		"El nombre del departamento es obligatorio y debe ser una cadena de texto."
	)
		.not()
		.isEmpty()
		.isString()
		...
		.withMessage(
			"El nombre del departamento debe tener máximo 50 caracteres, y solo puede contener letras, tildes y espacios."
		)
		.isLength({ max: 50 })
		.withMessage(
			"El nombre del departamento no puede exceder los 50 caracteres."
		),
