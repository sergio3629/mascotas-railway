...
usuarioRoutes.post('/solicitar-reset-password', solicitarResetPassword); // Solicitar recuperación
usuarioRoutes.post('/update-password', updatePassword); // Actualizar contraseña
