...
import { listarRazas, listarRazasPorCategoria, registrarRaza, actualizarRaza, eliminarRaza, buscarRaza } from "../controllers/razas.controller.js";
...
RazasRoutes.get("/listarRazasPorCategoria/:categoriaId", /* validarToken, */ listarRazasPorCategoria);
